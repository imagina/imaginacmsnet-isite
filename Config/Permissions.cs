namespace Isite.Config
{
  ...
  'isite.master.records': {
    ...
    'restore': 'isite::master.record.restore resource'
  },
  'isite.recommendations': {
    ...
    'restore': 'isite::recommendations.restore resource'
  },
  'isite.edit-link': {
  ...
  'isite.revisions': {
    'manage': 'isite::revisions.manage resource',
    'index': 'isite::revisions.list resource',
    'create': 'isite::revisions.create resource',
    'edit': 'isite::revisions.edit resource',
    'destroy': 'isite::revisions.destroy resource',
    'restore': 'isite::revisions.restore resource'
  }
}";
